  ...
  return (
    <div >
      ...
      <section className=" space-y-6">
        <div className=" shadow-sm rounded-xl w-full p-4">
          ...
          <Skeleton className="w-full h-16 mb-4 bg-gray-200" />
          <Skeleton className="w-full h-16 mb-4 bg-gray-200" />
          <Skeleton className="w-full h-16 mb-4 bg-gray-200" />
          <Skeleton className="w-full h-16 bg-gray-200" />
        </div>
        <div className="rounded-2xl shadow-sm w-full to-light-white p-4 flex flex-col gap-4">
